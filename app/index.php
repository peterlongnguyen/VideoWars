...
if (array_key_exists("topic_id", $_GET) && is_numeric($_GET["topic_id"])) {
...
echo "<a href='vote.php?win=" . $video_1["id"] . "&lose=" . $video_2["id"] . "&topic_id=" . $topic["id"] . "'>Vote (" . $video_1["name"] . ")</a><br />";
echo "<a href='vote.php?win=" . $video_2["id"] . "&lose=" . $video_1["id"] . "&topic_id=" . $topic["id"] . "'>Vote (" . $video_2["name"] . ")</a><br />";
